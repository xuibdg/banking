...
public enum GlobalErrorMapping {
    ...
    ID_LOAN_ACCOUNT_NOT_FOUND("IEG-0052", "ID Loan Account Tidak ditemukan. pastikan id yang dimasukkan sesuai!."),
    ID_LOAN_TYPE_NOT_FOUND("IEG-0052", "ID Loan Type Tidak ditemukan. pastikan id yang dimasukkan sesuai!."),
    ID_LOAN_CONFIG_NOT_FOUND("IEG-0052", "ID Loan Type Config Tidak ditemukan. pastikan id yang dimasukkan sesuai!."),
    ID_LOAN_TRANSACITON_NOT_FOUND("IEG-0052", "ID Loan Transaction Tidak ditemukan. pastikan id yang dimasukkan sesuai!."),
    ID_LOAN_REPAYMENTNOT_FOUND("IEG-0052", "ID Loan Repayment Tidak ditemukan. pastikan id yang dimasukkan sesuai!."),
