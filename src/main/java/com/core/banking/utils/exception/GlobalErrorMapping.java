...
public enum GlobalErrorMapping {
    ...
    SAVING_ACCOUNT_NOT_ACTIVE("IEG-0061", "ID Saving Account tersebut berstatus tidak aktif. Hint: Cek teliti kolom account_status."),
    SAVING_CUSTOMER_INEQUAL("IEG-0062", "ID Saving Account dan ID Customer tidak sama. Hint: Cek teliti kepemilikan saving account dan customer."),
